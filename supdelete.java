...
public class supdelete extends JFrame implements ActionListener
{
    JFrame f;
    JPanel pa1,head,min,close;
    JLabel title,entry,name,mob,email,com,headl,minl,closel;
    ...
    public supdelete()
    {
        ...
        headl=new JLabel("  Delete Supplier");
    ...
    public void actionPerformed(ActionEvent ae)
    {
        ...
        else if(ae.getSource()==ok)
        {
            try
                {
                        st=con.createStatement();
                        st.executeUpdate("DELETE FROM addsupplier WHERE sno="+value);
