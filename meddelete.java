...
public class meddelete extends JFrame implements ActionListener
{
    JFrame f,f1;
    ...
    JComboBox cmtype;
    JButton ok,preview,back,show,deletemore,delete;
    JTable list;
    ...
    public meddelete()
    {
        ...
        ok.setIcon(new javax.swing.ImageIcon(getClass().getResource("/medicalsoftwre/com/dcs/project/img/deletes.png")));
        add(ok);
        ...
        headl=new JLabel("  Delete Medicine");
    ...
    public void backrelease(java.awt.event.MouseEvent me)
    {
        ...
        public void actionPerformed(ActionEvent ae)
        {
            ...
            else if(ae.getSource()==ok)
            {
                ...
                {
                        st=con.createStatement();
                        st.executeUpdate("DELETE FROM addmedicine WHERE sno="+value);
    ...
    public void view()
   {
       ...
       model=new DefaultTableModel();
        ...
        sp.setBounds(0, 0, f.getWidth()-20, f.getHeight()-90);
        f.add(sp);
        
        deletemore=new JButton("delete more");
        deletemore.setBounds(f.getWidth()-120, f.getHeight()-80, 100, 30);
        f.add(deletemore);
        ...
        deletemore.addMouseListener(new java.awt.event.MouseAdapter() {
   ...
   {
       f1=new JFrame("delete data");
       f1.setBounds(350, 100, 750, 600);
       f1.setVisible(true);
       f1.setLayout(null);
       //f.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
       //f.setVisible(false);
       ...
       model=new DefaultTableModel();
        ...
        delete.setBounds(f1.getWidth()-120, f1.getHeight()-80, 100, 30);
        f1.add(delete);
        ...
        {
         JOptionPane.showMessageDialog(deletemore, e.getMessage());
        }
    
        //deletemore.addActionListener(this);
        
        
        
        f1.addWindowStateListener(new java.awt.event.WindowAdapter() {

            public void windowStateChanged(java.awt.event.WindowEvent evt) {
                
                sp.setBounds(0, 0, f1.getWidth()-20, f1.getHeight()-90);
                delete.setBounds(f1.getWidth()-120, f1.getHeight()-80, 100, 30);
                repaint();
            }
        });
        ...
        delete.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent me)
            {
                ...
                /*for(int i=0;i<=list.getSelectedRowCount()-1;i++)
                {
                    
                }*/
                rows=list.getSelectedRows();
                //JOptionPane.showMessageDialog(deletemore,list.getModel().getValueAt(rows[1], 0));
                for(int j=list.getSelectedRowCount()-1;j>=0;j--)
                {
                    
                    try
                    {
                        temp_row_id=list.getModel().getValueAt(rows[j], 0).toString();
                        st=con.createStatement();
                        st.executeUpdate("DELETE FROM addmedicine WHERE sno="+temp_row_id);
                        st.close();
                        model.removeRow(j);
                    }
                    catch(Exception e)
        ...
        try
        {
            ...
            while(rs.next())
            {
                String[] supdata={rs.getString("sno"),rs.getString("batchno"),rs.getString("name"),rs.getString("quantity"),rs.getString("purchasedate"),rs.getString("expdate"),rs.getString("purchaseprice"),rs.getString("saleprice"),rs.getString("tax"),rs.getString("rackno"),rs.getString("suppliername"),rs.getString("medicinecompany"),rs.getString("medicinetype")}; ;
                model.addRow(supdata);
                count++;
            }
            rs.close();
    ...
    public static void main(String a[])
    {
        try {
            ...
            java.util.logging.Logger.getLogger(meddelete.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
