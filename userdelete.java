...
public class userdelete extends JFrame implements ActionListener
{
    ...
    JLabel closel,minl,headl,delete;
    JButton back;
    ...
    public userdelete()
    {
        ...
        try
        {
            ...
            while(rs.next())
            {
                String[] supdata={rs.getString("sno"),rs.getString("name"),rs.getString("mpermission"),rs.getString("spermission"),rs.getString("bpermission"),rs.getString("email")};
        ...
        delete=new JLabel();
        delete.setBounds(1250, 613, 100, 130);
        delete.setIcon(new javax.swing.ImageIcon(getClass().getResource("/medicalsoftwre/com/dcs/project/img/meddelete.png"))); 
        ...
        delete.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            {
                int option=JOptionPane.showConfirmDialog(rootPane, "once you delete the data don't recover again, do you want to confirm delete this user from list");
    ...
    public void deleteUserData()
    {
        ...
        {
            st=con.createStatement();
            st.executeUpdate("DELETE FROM add_user WHERE sno="+value);
            st.close();
        }
        catch(Exception e){JOptionPane.showMessageDialog(rootPane, e.getMessage());}
    }
